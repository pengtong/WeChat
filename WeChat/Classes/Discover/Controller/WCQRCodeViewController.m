...
#import <MessageDisplayKit/XHCaptureHelper.h>
#import <MessageDisplayKit/XHVideoOutputSampleBufferFactory.h>
...
@interface WCQRCodeViewController ()
...
@implementation WCQRCodeViewController
...
- (XHCaptureHelper *)captureHelper
{
    if (!_captureHelper)
    {
        ...
        [_captureHelper setDidOutputSampleBufferHandle:^(CMSampleBufferRef sampleBuffer) {
            // 这里可以做子线程的QRCode识别
            WCLog(@"image : %@", [XHVideoOutputSampleBufferFactory imageFromSampleBuffer:sampleBuffer]);
        }];
    }
